...
config = {
    "kick": {
        ...
        "note": 36,
        "gain": 10,
        "curvePoints": [[0, 10], [192, 192], [128, 64], [256, 256]]
    },
    "snare": {
        "scan": 3000,
        "mask": 20000,
        ...
        "note": 38,
        "gain": 20,
        "curvePoints": [[0, 20], [192, 192], [128, 64], [256, 256]]
    },
    "hihat": {
        "scan": 3000,
        "mask": 20000,
        ...
        "note": 42,
        "gain": 30,
        "curvePoints": [[0, 30], [192, 192], [128, 64], [256, 256]]
    },
    "crash1": {
        "scan": 3000,
        "mask": 20000,
        ...
        "note": 49,
        "gain": 40,
        "curvePoints": [[0, 40], [192, 192], [128, 64], [256, 256]]
    },
    "tom1": {
        "scan": 3000,
        "mask": 20000,
        ...
        "note": 50,
        "gain": 50,
        "curvePoints": [[0, 50], [192, 192], [128, 64], [256, 256]]
    },
    "tom3": {
        "scan": 3000,
        "mask": 20000,
        ...
        "note": 41,
        "gain": 60,
        "curvePoints": [[0, 60], [192, 192], [128, 64], [256, 256]]
    },
    "ride": {
        "scan": 3000,
        "mask": 20000,
        ...
        "note": 51,
        "gain": 70,
        "curvePoints": [[0, 70], [192, 192], [128, 64], [256, 256]]
    },
    "tom2": {
        "scan": 3000,
        "mask": 20000,
        ...
        "note": 47,
        "gain": 80,
        "curvePoints": [[0, 80], [192, 192], [128, 64], [256, 256]]
    },
    "crash2": {
        "scan": 3000,
        "mask": 20000,
        ...
        "note": 57,
        "gain": 90,
        "curvePoints": [[0, 0], [192, 192], [128, 64], [256, 256]]
    },
    "hhc": {
        "timeout": 9000,
        "threshold": 30,
